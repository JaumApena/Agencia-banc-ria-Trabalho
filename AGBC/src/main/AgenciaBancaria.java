...
public class AgenciaBancaria {
    ...
    public static void operacoes() {
        ...
        System.out.println("------------------------------------------------------");
        System.out.println("-------------Bem vindos a AGBC---------------");
        System.out.println("------------------------------------------------------");
        ...
        System.out.println("|   Opção 6 - Sair1          |");
    ...
    public static void transferir() {
    	System.out.println("----------------------------");
    	System.out.println("Como deseja realizar a transferência");
    	System.out.println("|   Opção 1 - PIX   |");
        System.out.println("|   Opção 2 - TED     |");
    	System.out.println("----------------------------");
    	...
    	if(transf == 1) {
    		...
    		System.out.println("Número da conta que vai enviar o PIX: ");
        ...
        System.out.println("Número da conta que vai enviar a TED: ");
        int numeroContaRemetente = input.nextInt();
